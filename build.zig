...
pub fn build(b: *std.Build) void {
    ...
    const config: Config = cfg: {
        ...
        const cfg_lua_version = b.option(LuaLanguage, "lua-version", "version of Lua to link (default: 5.5)") orelse .@"5.5";
        const cfg_lua_libname = b.option([]const u8, "lua-libname", "the name of the system library to link (default: lua-<lua-version>)");
